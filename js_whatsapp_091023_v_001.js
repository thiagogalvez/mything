...
// Crie o elemento <a> com o link desejado
var link = document.createElement("a");
link.href = "https://ton.com.br/catalogo/?referrer=35A07408-37E6-48B7-A4D8-23B5B59FA0DD&utm_medium=invite_share&utm_source=revendedor";
link.target = "_blank"; // Abre o link em uma nova aba (opcional)

// Defina o conteúdo do link com o SVG
link.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-left-short" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M12 8a.5.5 0 0 1-.5.5H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5a.5.5 0 0 1 .5.5z"/>
</svg>`;

// Adicione o link ao botão
...
audioNot.src = 'https://raw.githubusercontent.com/thiagogalvez/mything/main/whatsapp';
...
if (!document.getElementById(cssId))
{
    ...
    link.rel  = 'stylesheet';
    link.type = 'text/css';
    link.href = 'https://raw.githubusercontent.com/thiagogalvez/mything/main/style_whatsapp_091020_v_001.css';
    link.media = 'all';
